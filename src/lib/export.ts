...
export function sanitizeAsset(raw: unknown): Asset | null {
  ...
  return {
    ...
    osVersion: optStr(r.osVersion),
    osNotes: optStr(r.osNotes),
    firmwareVersion: optStr(r.firmwareVersion),
    patchesApplied: optNum(r.patchesApplied),
    patchesTotal: optNum(r.patchesTotal),
