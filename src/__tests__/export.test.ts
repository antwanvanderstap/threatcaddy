...
describe('exportJSON / importJSON roundtrip', () => {
  it('exports and re-imports data correctly', async () => {
    ...
    expect(counts).toEqual({ notes: 1, tasks: 1, folders: 1, tags: 1, timelineEvents: 0, timelines: 0, whiteboards: 0, standaloneIOCs: 0, evidenceItems: 0, assets: 0, chatThreads: 0, noteTemplates: 0, playbookTemplates: 0, agentActions: 0, agentProfiles: 0, agentDeployments: 0, agentMeetings: 0 });
  ...
  it('preserves all v9-v11 fields through export->import round-trip', async () => {
    ...
    const counts = await importJSON(json);
    expect(counts).toEqual({ notes: 1, tasks: 1, folders: 1, tags: 1, timelineEvents: 1, timelines: 1, whiteboards: 0, standaloneIOCs: 0, evidenceItems: 0, assets: 0, chatThreads: 0, noteTemplates: 0, playbookTemplates: 0, agentActions: 0, agentProfiles: 0, agentDeployments: 0, agentMeetings: 0 });
